# Lab 27 — Correzione verifica finale e chiusura corso

## Obiettivo

Rivedere i risultati della verifica finale, correggere gli errori comuni e ricevere il voto finale del corso.

## Durata (timebox)

Intera lezione (3 ore)

## Prerequisiti

- Aver sostenuto la verifica finale (Lezione 26)

## Attività

### Parte 1 — Correzione collettiva (60 min)
...
5. **Restituzione voti**: ogni studente riceve il proprio voto dettagliato (Parte A + Parte B1 + Parte B2).
6. **Commenti specifici**: il docente fornisce feedback sul notebook di ciascuno studente.
7. **Voto finale del corso**: Midterm (50%) + Verifica finale (50%).
8. **Domande**: spazio per chiarimenti sul voto o sugli argomenti.
...
- Comprensione degli errori commessi nella verifica
- Voto finale ricevuto
- Lista di risorse per approfondimento

## Checkpoint

- [ ] Ho capito dove ho sbagliato nella verifica
- [ ] Ho ricevuto il mio voto finale
- [ ] Ho salvato la lista di risorse per continuare a imparare
